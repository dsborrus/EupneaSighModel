...
%\begin{figure}[h!]
	...
	\begin{tikzpicture}
		...
		\begin{axis}[
			...
			\addplot[black,thick] table[mark=none] {../data/data_D1.dat};
			\addplot[Gray,thick] table[mark=none] {../data/data_D2.dat};
			\addplot[blue,dashed,thick] table[mark=none] {../data/data_D3.dat};				
			\legend{$\dot{C}_{\text{cyt}}=0$ \hskip 5mm,$\dot{C}_{\text{total}}=0$};	
		\end{axis}

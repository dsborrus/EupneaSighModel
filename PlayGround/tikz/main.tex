...
%		\pgfmathsetmacro{\xmax}{2027}
		...
		\pgfdeclareimage{panB}{PanelB/PanelB_v2.pdf}

		\node (A) {\pgfuseimage{panA}};
		\node (B) [right = of A, xshift = -1.0cm, yshift=3.6cm] {\pgfuseimage{panB}};
		
		\node at (0,7.5) {Simulated (Previous Version)};
		\node at (0,-0.5) {Simulated (Patch)};
		\node at (10.75,7) {\it in vitro};

...
if writetraj
    ...
    if ~strcmp(filenametraj,'default') && ismac
        system(['cp traj.dat ' filenametraj '.dat '  ]);
    elseif ~strcmp(filenametraj,'default') && ispc
        system(['copy traj.dat ' filenametraj '.dat '  ]);
    end
    fclose(fid);
    if ismac
...
if writehist
    ...
    fclose(fid);
    if ~strcmp(filenamehist,'default') && ismac
        system(['cp hist.dat ' filenamehist '.dat '  ]);
    elseif ~strcmp(filenamehist,'default') && ispc
        system(['copy hist.dat ' filenamehist '.dat '  ]);
    end
    if ismac

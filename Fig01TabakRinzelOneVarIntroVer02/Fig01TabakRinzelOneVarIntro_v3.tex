...
\addplot[thick,black,solid] coordinates {(3.4,0.86)(4.8,0.86)};
\addplot[thick,white,dashed] coordinates {(3.4,0.86)(4.8,0.86)};
\end{axis}
\begin{axis}[
		xshift=6cm,
		yshift=-6cm,
...
\addplot[thick,black,solid] coordinates {(0,0.91)(35,0.91)};
\addplot[thick,white,dashed] coordinates {(0,0.91)(35,0.91)};
\end{axis}
\begin{axis}[
xshift=18cm,
yshift=-6cm,
